# AmmalgamPair
[Git Source](https://github.com/Ammalgam-Protocol/core-v1/blob/bab12491a59b8a6007058139c71cddb33c6f5ccb/contracts/AmmalgamPair.sol)
...
```solidity
function _repay(address onBehalfOf, uint256 repayXAssets, uint256 repayYAssets) private;
```
