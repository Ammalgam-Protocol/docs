# AmmalgamPair
[Git Source](https://github.com/Ammalgam-Protocol/core-v1/blob/2147358c53f5b1c77eb18db72089539dd0f4e5b9/contracts/AmmalgamPair.sol)
...
function _repay(
    ...
    returns (
        ...
        uint256 actualRepaidXInXAssets,
        uint256 actualRepaidYInYAssets
    );
```
