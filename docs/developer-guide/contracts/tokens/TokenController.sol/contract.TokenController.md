# TokenController
[Git Source](https://github.com/Ammalgam-Protocol/core-v1/blob/8fc748c1c16ecab3f73d50349b9aef67744957c4/contracts/tokens/TokenController.sol)
...
### newTotalDepositAssets

```solidity
uint112 internal transient newTotalDepositAssets;
```
...
function rawTotalAssets(
    uint256 tokenType
) internal view returns (uint112 assetAmount);
```
