# TokenController
[Git Source](https://github.com/Ammalgam-Protocol/core-v1/blob/fb75a130dc9f305802a2ff86ff4032ac81e97806/contracts/tokens/TokenController.sol)
...
```solidity
function burnId(uint256 tokenType, address sender, address to, uint256 assets, uint256 shares_) internal;
```
