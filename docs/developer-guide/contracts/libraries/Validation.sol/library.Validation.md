# Validation
[Git Source](https://github.com/Ammalgam-Protocol/core-v1/blob/15372364f447bc8a3cfdf61e53c38abb19412d55/contracts/libraries/Validation.sol)
...
function getDepositsInL(
    ...
    uint256 sqrtPriceMinInQ72,
    uint256 sqrtPriceMaxInQ72
) internal pure returns (uint256 netDepositedXinLAssets, uint256 netDepositedYinLAssets);
```
...
function getBorrowedInL(
    ...
    uint256 sqrtPriceMinInQ72,
    uint256 sqrtPriceMaxInQ72
) internal pure returns (uint256 netBorrowedXinLAssets, uint256 netBorrowedYinLAssets);
```
