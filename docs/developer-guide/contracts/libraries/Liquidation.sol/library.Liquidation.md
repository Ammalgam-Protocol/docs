# Liquidation
[Git Source](https://github.com/Ammalgam-Protocol/core-v1/blob/9e2e4860004d166d43e104b933bcb6c16866d6fb/contracts/libraries/Liquidation.sol)
...
the premium increased, in code we call this `LEVERAGE_LIQUIDATION_BREAK_EVEN_FACTOR_MAG2`, and
...
struct LeveragedLiquidationParams {
    ...
    uint256 seizeInXAssets;
    uint256 seizeInYAssets;
    bool badDebt;
}
```
