...
[Git Source](https://github.com/Ammalgam-Protocol/core-v1/blob/7e1bc8c0bed339c4fdc8f6935163845021887015/contracts/interfaces/ISaturationAndGeometricTWAPState.sol)
...
|`fragileLiquidityAssets`|`uint256`| liquidity that may require seized in a liquidation to be excluded from available liquidity.|
