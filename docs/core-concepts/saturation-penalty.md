...
[accruePenalties](/docs/developer-guide/contracts/libraries/Saturation#accruepenalties)
...
ref: [calcSaturationPenaltyRatePerSecondInWads](/docs/developer-guide/contracts/libraries/Saturation#calcsaturationpenaltyratepersecondinwads) in Saturation.sol
