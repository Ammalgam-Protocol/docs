# Validation
[Git Source](https://github.com/Ammalgam-Protocol/core-v1/blob/a776754587e2530d31f83af30e82bc8095fad927/contracts/libraries/Validation.sol)


## Functions
### validateSolvency

Added uint8 and uint256s for amount, balance from, and balance to
...
struct VerifyMaxBorrowLParams {
    uint256 newBorrowedLShares;
    uint112 reserveXAssets;
    uint112 reserveYAssets;
    uint8 maxBorrowPercentage;
    uint256 depositedXAssets;
    uint256 depositedYAssets;
    uint256 totalLiquidityAssets;
